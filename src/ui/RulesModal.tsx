    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ol className="small">
          ...
          <li>
            <b>朝の準備（セリ前）</b>：<b>配置転換</b>（営業↔製造を移動）と<b>解凍</b>（冷凍庫から出す）。
            解凍は<b>翌日</b>使える状態になり、その日に加工/販売しないと腐ります（再冷凍不可）。
          </li>
          <li>
            <b>魚は生もの</b>：仕入れた生の原魚は、その日のうちに<b>加工・冷凍・販売</b>のいずれかをしないと翌朝腐ります。
            日をまたいで持ち越すには<b>冷凍</b>が必要です。
          </li>
          <li>
          ...
          <li>
            <b>投資（5期ごと）</b>：在庫拡張・製造ライン・研修・採用・認証取得・<b>商品開発</b>・借入。
          </li>
        </ol>
        <p className="small muted">
          ※ <b>商品開発</b>：マダイ茶漬け／カツオのたたき／サバの味噌煮／白子（加工品強）は、3000円で開発しないと作れません。<br />
          ※ <b>開業借入</b>：ゲーム開始時に資本金の最大2倍まで借りられます（利率3%/期）。
        </p>
